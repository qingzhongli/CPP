...
/*
[root@sdtp-dev examples-liqingzhong]# g++ -g param-reference.cpp  -std=c++11
param-reference.cpp: In function ‘int main()’:
param-reference.cpp:27:65: warning: non-constant array size in new, unable to verify length of initializer-list [enabled by default]
      matA.pData = new float[matA.rows * matA.cols]{1.f, 2.f, 3.f};
                                                                 ^
param-reference.cpp:30:67: warning: non-constant array size in new, unable to verify length of initializer-list [enabled by default]
     matB.pData = new float[matB.rows * matB.cols]{10.f, 20.f, 30.f};
                                                                   ^
param-reference.cpp:33:70: warning: non-constant array size in new, unable to verify length of initializer-list [enabled by default]
     matC.pData = new float[matC.rows * matC.cols]{100.f, 200.f, 300.f};
                                                                      ^
